...
<div style="color:red;font-weight:bold">
         <?php
          ...
          // $value = mysqli_fetch_object($result);  
          while($row = mysqli_fetch_array($result)){ 
            $exceed = (int)$row['SUM(VolumeOfWater)'] - 2;
            if ($exceed > 0){
...
"; //You don't need a ; like you do in SQL
$queryMorning = "Select Date, SUM(VolumeOfWater) from WaterSensor.Readings Where SensorID = '$sensor' AND Date= CURDATE() AND Time BETWEEN '00:00:00' AND '12:00:00' GROUP BY Date;"; //You don't need a ; like you do in SQL
$queryAfternoon = "Select Date, SUM(VolumeOfWater) from WaterSensor.Readings Where SensorID = '$sensor' AND Date= CURDATE() AND Time BETWEEN '12:00:00' AND '16:00:00' GROUP BY Date;"; //You don't need a ; like you do in SQL
$queryEvening = "Select Date, SUM(VolumeOfWater) from WaterSensor.Readings Where SensorID = '$sensor' AND Date= CURDATE() AND Time BETWEEN '16:00:00' AND '20:00:00' GROUP BY Date;"; //You don't need a ; like you do in SQL
$queryNight = "Select Date, SUM(VolumeOfWater) from WaterSensor.Readings Where SensorID = '$sensor' AND Date= CURDATE() AND Time BETWEEN '20:00:00' AND '00:00:00' GROUP BY Date;"; //You don't need a ; like you do in SQL
...
<br><br>
<div class=myflex>
<div style="margin-left:31%" id="containerPie"></div>
</div>
<br><br><br>
